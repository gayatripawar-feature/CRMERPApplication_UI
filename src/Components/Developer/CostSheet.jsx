...
const handleSave = () => {
  ...
  console.log("Values - Visit Rate:", visitRate, "Booking Rate:", bookingRate, "Stamp Duty:", stampDuty);

  if (!visitRate || !bookingRate || !stampDuty) {
...
<div className="d-flex align-items-center mb-3">
  ...
  >
    ...
    <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      {isExpanded && <span style={{ color: 'white', fontSize: '16px', marginLeft: '8px' }}>Cost Sheet</span>} 
    </div>
  </Button>
</div>
...
<div className="button-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
  ...
  <Button 
    ...
    className="fw-bold"  style={{ background: Constants.primaryColor }}
  >
