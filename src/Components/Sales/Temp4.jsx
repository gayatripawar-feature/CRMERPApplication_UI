...
//             // ✅ Check if autoTable exists before calling it
//             if (typeof doc.autoTable !== "function") {
//                 console.error("autoTable is not defined!");
//                 alert("autoTable function is missing! Restart your app.");
//                 return;
//             }
...
//     <div>    
//     <div style={{  opacity: 0, position: 'absolute', left: '-9999px' }} id="table-content">
//   <PDFContent />
// </div>
