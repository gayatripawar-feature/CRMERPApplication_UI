...
const PackageDownloadPDF = ({ modalContent }) => {
  const handleGeneratePDFPackage = () => {
    ...
    doc.text("Negotiation Calculation (Package Wise)", pageWidth / 2, y, { align: "center" });
    y += lineHeight + 5;
    ...
    // Save the PDF
    doc.save("PackageDetails.pdf");
  };

  if (modalContent !== "packageDisplay") return null;
...
export default PackageDownloadPDF;