...
const handleClearFilters = () => {
  ...
  //   if (selectedTab === "followuphistory") {
  //     // Extract dates from statusHistory for filtering
  //     if (lead.statusHistory) {
  //       // Parse statusHistory to find dates - looking for patterns like "ii. 12/03/24, 4:30 PM"
  ...
  //           // Convert to Date object (assuming format DD/MM/YY or DD/MM/YYYY)
  ...
  //             break; // Use the first (most recent) date found
  //           }
  //         }
  //       }
  //     }

  //     // Fallback to existing logic if no date found in statusHistory
  //     if (!leadDate) {
  //       const rawDate =
  //         lead.lastUpdatedDate && lead.lastUpdatedDate !== "0001-01-01T00:00:00"
  //           ? new Date(lead.lastUpdatedDate)
  ...
  //     // ✅ For Visit tab, ONLY use timestamp (lastUpdatedDate) for filtering
  //     const rawDate =
  //       lead.lastUpdatedDate && lead.lastUpdatedDate !== "0001-01-01T00:00:00"
  //         ? new Date(lead.lastUpdatedDate)
  //         : lead.createdDate && lead.createdDate !== "0001-01-01T00:00:00"
  ...
  //     console.groupEnd();
  //   } else {
  //     // Existing logic for other tabs (pendingfollowup, lost)
  //     const engagement =
  //       lead.leadEnagagements?.[0] || lead.leadEngagements?.[0];
  //     leadDate = engagement?.nextFollowUp
  //       ? new Date(engagement.nextFollowUp)
  ...
  //     // ✅ SPECIAL FILTERING FOR LOST TAB - Use nextFollowUp date
  //     console.group(`🔍 Filtering Lost Lead: ${lead.name} (ID: ${lead.id})`);

  //     // Check for nextFollowUp in different possible locations
  //     if (lead.nextFollowUp) {
  //       leadDate = new Date(lead.nextFollowUp);
  //       console.log(
  //         "✅ Found nextFollowUp in lead:",
  //         lead.nextFollowUp,
  //         "->",
  //         leadDate
  //       );
  //     } else if (lead.leadEnagagements?.[0]?.nextFollowUp) {
  //       leadDate = new Date(lead.leadEnagagements[0].nextFollowUp);
  //       console.log(
  //         "✅ Found nextFollowUp in leadEnagagements:",
  //         lead.leadEnagagements[0].nextFollowUp,
  //         "->",
  //         leadDate
  //       );
  //     } else if (lead.leadEngagements?.[0]?.nextFollowUp) {
  //       leadDate = new Date(lead.leadEngagements[0].nextFollowUp);
  //       console.log(
  //         "✅ Found nextFollowUp in leadEngagements:",
  //         lead.leadEngagements[0].nextFollowUp,
  //         "->",
  //         leadDate
  //       );
  //     } else {
  //       console.log("❌ No nextFollowUp found in lead data");
  //       leadDate = null;
  //     }
  //     console.groupEnd();
  //   } else {
  //     // Existing logic for other tabs (pendingfollowup)
  //     const engagement =
  //       lead.leadEnagagements?.[0] || lead.leadEngagements?.[0];
  //     leadDate = engagement?.nextFollowUp
  //       ? new Date(engagement.nextFollowUp)
