      ...
      <div className="d-flex flex-wrap align-items-center mb-3">
        {buttons.map((btn, index) => (
          <div key={index} style={{ margin: "10px" }}>
            <Button onClick={() => setSelectedTab(btn.label)} variant="outlined" color={selectedTab === btn.label ? "primary" : "success"} className="m-2"
              style={{ borderRadius: "20px", minWidth: "150px", padding: "6px", display: "flex", alignItems: "center", gap: "8px", background: Constants.primaryColor, border: "none", color: "white", }} >
              <div style={{ width: "35px", height: "35px", borderRadius: "50%", background: Constants.primaryColor, display: "flex", alignItems: "center", justifyContent: "center", }} >
                {btn.icon}
              </div>
              <span>{btn.label}</span>
            </Button>
          ...
          <Box>
            <Box mb={3}>
              ...
              <Button
                ...
                style={{ marginRight: "10px" }}
                sx={{ background: Constants.primaryColor }} >  Filter  </Button>
              <Button variant="outlined" color="secondary" onClick={handleReset}>   Reset </Button>
            </Box>
            <Box mt={4}><TimeSeriesChart data={filteredChartData} />
            </Box>
          </Box>
        )}
          ...
          <Box>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={barData}>
                    ...
                    <YAxis
                      ...
                      ticks={[0, 5, 10, 15, 20, 25, 30, 35]} />  <Tooltip />
                    <Bar dataKey="count">
            ...
            <Box mt={3} p={2} boxShadow={3} borderRadius={2} bgcolor="white">
              ...
              <TableContainer component={Paper}
                style={{ maxHeight: '300px', overflowY: 'auto', display: 'block', height: 'auto', width: '100%' }} >
                <Table>
                  <TableHead>
          ...
          <Box>
            ...
            <Box sx={{ maxHeight: '600px', overflowY: 'auto', mb: 2 }}>
              ...
              <Box display="flex" justifyContent="space-between" alignItems="center" mt={4}>
                <Box width="50%">
                  <Typography variant="h6" align="center" gutterBottom sx={{ fontWeight: 'bold' }}>  Lead Distribution Overview</Typography>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                ...
                <Box width="50%">  <SourceMetrics />  </Box>
              </Box></Box> </Box>
        )}
