...
//   const handleToggleSection = (index) => {
//     if (index === 0) {
//       // First tab → Display Enquiries
//       setExpandedSection(0);
//     } else if (index === 1) {
//       // Second tab → Pending Follow Up should show index 2
...
//     }
//        if (index === 1) {
//       console.log(" Pending Follow-up section opened — calling API...");
//       fetchPendingfollowupLeads();
//     }
//   };
...
//     setCompany(selectedLead.company || "");
//     setInterestedIn(selectedLead.interest || "");
//     setBudget(selectedLead.budgetInLakh?.toString() || "");
//     setOccupation(selectedLead.occupation || "");
//     setReferenceBySource(selectedLead.source || "");
//     setNameOfCp(selectedLead.nameOfCp || "");
//     setPlanningToBuy(selectedLead.intendedPurchasePeriodMonths || "");
//     setRemarks(selectedLead.remarks || "");
//   } else {
//     console.warn("⚠️ No matching lead found for ID:", selectedId);
//   }
// };
...
//   const fetchPendingfollowupLeads = async () => {
//   try {
//     console.log("📡 Fetching all Pending Follow-up Leads (no status filter)...");
...
//     if (!response.ok) {
//       throw new Error("Failed to fetch pending follow-up leads");
//     }

//     const data = await response.json();
// console.log(" Pending Followup — Raw data received:", data);



//     // Directly set all leads — no filtering by status
//     setLeads(data);

//   } catch (error) {
//     console.error("❌ Error fetching all pending follow-up leads:", error);
//   }
// };
