...
const Leads = () => {
  ...
  //       });
  //  //  Count leads per week based on assigned salesperson 
  //       inventoryData.forEach((lead, idx) => {
  //         const dateValue =
  //           lead.lastUpdatedDate ||
  //           lead.Timestamp ||
  ...
  //   "Unassigned";
  //         // Only count if salesperson exists in static list
  ...
  //       const wsData = [];
  //  wsData.push(["Sales Person", ...weeks.map((w) => w.label)]);
  // salesPersons.forEach((person) => {
  //         wsData.push([person, ...salesCounts[person]]);
  //       });
  // const ws = XLSX.utils.aoa_to_sheet(wsData);
  //       XLSX.utils.book_append_sheet(wb, ws, "SalesPerson Report");
  //       XLSX.writeFile(wb, `${month}_SalesPersonWise_Report.xlsx`);
